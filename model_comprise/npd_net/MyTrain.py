...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default='/root/nfs/gaobin/wt/Datasets/Polyp/TrainDataset')
    ...
    parser.add_argument("--gt_encoder_model", type=str, default='')
    parser.add_argument("--model_path", type=str, default='/root/nfs/gaobin/wt/PolypSeg_2/model_comprise/npd_net/weight/')
