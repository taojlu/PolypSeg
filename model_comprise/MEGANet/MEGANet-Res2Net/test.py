...
parser.add_argument('--pth_path', type=str, default='/root/nfs/gaobin/wt/Checkpoints/Polyp_Project_2/MEGANet-Res2Net/MEGANet-199.pth')

for _data_name in ['CVC-300', 'CVC-ClinicDB', 'Kvasir', 'CVC-ColonDB', 'ETIS-LaribPolypDB']:
    data_path = '/root/nfs/gaobin/wt/Datasets/Polyp/TestDataset/{}'.format(_data_name)
    save_path = '/root/nfs/gaobin/wt/Datasets/Polyp/Results/RESULT_MAP/MEGANet-Res2Net/{}/'.format(_data_name)
