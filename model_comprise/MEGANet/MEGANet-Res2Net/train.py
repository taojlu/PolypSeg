...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='/root/nfs/gaobin/wt/Datasets/Polyp/TrainDataset', help='path to train dataset')
    parser.add_argument('--train_save', type=str,
                        default='/root/nfs/gaobin/wt/Checkpoints/Polyp_Project_2/MEGANet-Res2Net/')
