...
from model_comprise.ResNet import resnet34
import os
import math
from einops import rearrange

"""
https://github.com/szuzzb/META-Unet/blob/main/META-Unet.py
"""
class CBR(nn.Module):
    """
...
class META_Unet(nn.Module):
    def __init__(self, nIn=3, classes=1, p1=4, p2=4, p3=4):
...
if __name__ == "__main__":
    ...
    model = META_Unet()
    model.eval()
    inputs = torch.rand(size=(1, 3, 352, 352))
