...
def get_edge_loader(image_root, gt_root, batchsize, trainsize, shuffle=True, num_workers=4, pin_memory=True,
               augmentation=True):
...
if __name__ == '__main__':
    ...
    # train_loader = get_edge_loader(image_root, gt_root, batchsize=1,
