    ...
    for num in img_list:
        ...
        if len(polyp_contours) == 1:
            ...
            if len(edge_contours) == 1:
                ...
                poly_coherence = calculate_edge_coherence(polyp_contours[0])
                ...
                if polyp_perimeter < 500:
                    if poly_coherence < edge_coherence:
                        if polyp_perimeter > edge_perimeter:
                            edge_final = polyp_image + output_image
                        else:
                            edge_final = polyp_image
                    elif poly_coherence > edge_coherence:
                        edge_final = polyp_image
                elif polyp_perimeter > 500 and polyp_perimeter < 1000:
                    if polyp_smoothness < edge_smoothness:
                            edge_final = polyp_image + output_image
                    elif polyp_smoothness > edge_smoothness:
                        edge_final = polyp_image
                elif polyp_perimeter > 1000:
                    if polyp_smoothness < edge_smoothness:
                        edge_final = polyp_image
                    elif polyp_smoothness > edge_smoothness and polyp_perimeter > edge_perimeter:
                        edge_final = polyp_image
                    elif polyp_smoothness > edge_smoothness and polyp_perimeter > edge_perimeter:
