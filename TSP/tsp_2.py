...
def simulated_annealing(tour, distance_matrix, initial_temp=10000, cooling_rate=0.995, min_temp=1, device=None):
    """模拟退火算法"""
...
if tour_distance == float('inf'):
    ...
    optimized_tour = simulated_annealing(optimized_tour, distance_matrix, device=devices[0])
