...
class DSSAttention(nn.Module):
    def __init__(self, embed_dim, num_heads, sr_ratio, qkv_bias=False, attn_dropout=0.0, proj_dropout=0.0, block_size=16):
        super(DSSAttention, self).__init__()
        self.embed_dim = embed_dim
        self.num_heads = num_heads
        self.sr_ratio = sr_ratio
        self.block_size = block_size  # 稀疏注意力的块大小
        ...
        # 动态聚焦层
        self.dynamic_focus = nn.Conv2d(embed_dim, embed_dim, kernel_size=1)
...
class PVT_UNet_NewAtt_Test(nn.Module):
    def __init__(self, channel=32,
        ...
        super(PVT_UNet_NewAtt_Test, self).__init__()
...
if __name__ == '__main__':
    ...
    model = PVT_UNet_NewAtt_Test().cuda()
