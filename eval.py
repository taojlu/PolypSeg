...
def evaluate(args):
    ...
    datasets = os.listdir(args.pred_root)
    ...
    model_name, model_subfolder = args.pred_root.split('/')[-2:]
...
if __name__ == "__main__":
    def parse_args():
        ...
        parser.add_argument('--model_name', type=str, default='MaCbamFormer')
        parser.add_argument('--pred_root', type=str, default='/root/nfs/gaobin/wt/Datasets/Polyp/Results/RESULT_MAP/')
        parser.add_argument('--gt_root', type=str, default='/root/nfs/gaobin/wt/Datasets/Polyp/TestDataset')
        parser.add_argument('--result_path', type=str,
                            default='/root/nfs/gaobin/wt/Datasets/Polyp/Results/RESULT_EXCELS')
    ...
    # 定义模型名称到文件夹和子文件夹的映射
    model_mappings = {
        'U_Net': '2024-04-03_21-59-02and99_train_loss_0',
        'AttU_Net': '2024-04-03_21-57-42and99_train_loss_0',
        'GroupMixFormer': '2024-04-13_17-01-23and133_net_dice_0',
        'GroupMixFormerSupervise': '2024-04-03_21-55-44and99_train_loss_0',
        'PolypPVT': '2024-07-29_09-21-37andPolypPVT',
        'SwimGroupFormer': '2024-04-03_22-06-23and99_train_loss_0',
        'SwimGroupMixFormer': '2024-04-04_16-31-10and99_train_loss_0',
        'M2SNet': '2024-04-03_22-02-31and99_train_loss_0',
        'HighResolutionNetOCR': '2024-04-04_17-14-51and98_net_dice_0',
        'PVT_UNet': '2024-08-01_06-16-59and118_net_dice_0',
        'PVT_UNet_NewAtt': '2024-08-04_02-43-52and52_net_dice_0',
        'MaCbamSuperbisionFormer': '2024-08-12_14-31-41and17_net_dice_0',
        'MaCbamFormer': '',
        'VMUNet': '2024-09-09_23-00-05and34_net_dice_0',
        'FUSION':'small_fusion',
        'PvtFormer': '2024-08-09_22-44-22and21_net_dice_0',
        'PvtMaFormer': '2024-08-10_01-37-06and26_net_dice_0',
        'MaCbamFormer': '2024-08-10_03-14-52and22_net_dice_0'
    ...
    # ==================== 单独模型预测评价 ===================
    args_dict['pred_root'] = os.path.join(args.pred_root, model_folder, model_subfolder)
    # ==================== 计算结果保存 ===================
